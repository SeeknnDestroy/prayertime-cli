...
```
      ...
      --field string          Single canonical field to return, such as seconds_remaining or target_at
  -h, --help                  help for countdown
      --lat float             Latitude coordinate
      --lon float             Longitude coordinate
      --query string          Place name to resolve before fetching prayer times
  -q, --quiet                 Shortcut for --output value
      --target string         Target prayer such as next-prayer, imsak, fajr, sunrise, dhuhr, asr, maghrib, sunset, isha, or iftar
